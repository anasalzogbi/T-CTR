...
do
    ...
    for k in 200
    do
        screen -S Rocchio_CTR_notpapers_notusers_Normalized_cosine_${folder}_k_${k} -dm bash -c " source /home/alzoghba/HyPRec/py3.5_hyprec/bin/activate;  \
        ...
        -s cosine \
        -e CTR_Rocchio_notpapers_notusers_normalized_cosine_k_${k} \
